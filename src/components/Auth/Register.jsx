      ...
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
          <form onSubmit={handleRegister} className="max-w-lg w-full mx-auto">
            ...
            <div>
              <label htmlFor="name" className="text-white text-xs block mb-2">Full Name</label>
            ...
            <div className="mt-4">
              <label htmlFor="email" className="text-white text-xs block mb-2">Email</label>
              <div className="relative flex items-center">
                <input 
                  id="email"
                  name="email"
                ...
                />
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" className="w-[18px] h-[18px] absolute right-2" viewBox="0 0 682.667 682.667">
            ...
            <div className="mt-4">
              <label htmlFor="password" className="text-white text-xs block mb-2">Password</label>
              <div className="relative flex items-center">
                <input 
                  id="password"
                  name="password"
                ...
                />
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" className="w-[18px] h-[18px] absolute right-2 cursor-pointer" viewBox="0 0 128 128">
            ...
            <div className="mt-4">
              <label htmlFor="phone" className="text-white text-xs block mb-2">Phone</label>
              <div className="relative flex items-center">
                <input 
                  id="phone"
                  name="phone"
            ...
            <div className="mt-4">
              <label htmlFor="role" className="text-white text-xs block mb-2">Select Role</label>
              <div className="relative flex items-center">
                <select 
                  id="role"
                  name="role"
            ...
            <div className="flex items-center mt-6">
              ...
              <label htmlFor="remember-me" className="text-white ml-3 block text-sm">
                I accept the <a href="/terms" className="text-yellow-500 font-semibold hover:underline ml-1">Terms and Conditions</a>
              </label>
            </div>
            ...
            <div className="mt-5">
              ...
              <p className="text-sm text-white mt-5">Already have an account? <Link to="/login" className="text-yellow-400 font-semibold hover:underline ml-1">Login here</Link></p>
            </div>
          </form>
        </div>
      </div>
